...
export function InventoryView({ initialProducts }: { initialProducts: StoredProduct[] }) {
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    {p.restockRecommended ? (
                      ...
                      <span className="font-mono text-muted-foreground">{p.predictedStockoutDays}d</span>
                    )}
                  </td>
                </tr>
              ))}
